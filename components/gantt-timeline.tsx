...
export function GanttTimeline() {
  ...
  // Generate months for the timeline (July 2025 to March 2026)
  const generateMonths = () => {
    const months = []
    const startDate = new Date(2025, 6, 1) // July 2025 (month 6 = July)
    for (let i = 0; i < 9; i++) {
      // 9 months: July 2025 to March 2026
  ...
  const getTimelinePosition = (startDate: string, endDate?: string) => {
    ...
    const timelineEnd = new Date(2026, 2, 31) // March 2026 (month 2 = March, day 31 for full month)
    ...
    // Use pixel values based on measured timeline width
    const leftPx = timelineWidth * (startDays / totalDays)
    const widthPx = Math.max(1, timelineWidth * (duration / totalDays))
  ...
  const getTodayPosition = () => {
    ...
    const timelineStart = new Date(2025, 6, 1) // July 2025
    const timelineEnd = new Date(2026, 2, 31) // March 2026
  ...
  useEffect(() => {
    ...
    // Responsive: measure timeline area width
    const handleResize = () => {
                  ...
                  return (
                    <div key={loe.id} className="relative">
                      <div className="flex">
                        ...
                        {/* Timeline Area */}
                        <div ref={timelineAreaRef} className="flex-1 relative min-h-[120px] bg-gray-50 rounded-lg p-2 pr-32">
                          {/* Grid lines */}
